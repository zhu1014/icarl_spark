...
def get_parser():
    ...
    parser.add_argument("--data-path", default="/data_1/", type=str)

    # Training related:
    parser.add_argument("-lr", "--lr", default=0.3, type=float,
                        help="Learning rate.")
    parser.add_argument("-wd", "--weight-decay", default=0.0001, type=float,
                        help="Weight decay.")
    parser.add_argument("-sc", "--scheduling", default=[140, 180], nargs="*", type=int,
    ...
    parser.add_argument("--loss-type", default="logit", type=str)
    parser.add_argument("--loss-rate", default=0, type=float)
    parser.add_argument("--gcn-hidden", default=16, type=int)
    parser.add_argument("--gcn-dropout", default=0.5, type=float)
    parser.add_argument("--connect-num", default=10, type=int)
    parser.add_argument("--connect-all", default=False, action="store_true")
    parser.add_argument("--update-every-time", default=False, action="store_true")
    parser.add_argument("--use-gcn", default=False, action="store_true")
    parser.add_argument("--task-epoch", default=[70], type=int, nargs="+")
    parser.add_argument("--task-lr", default=[0.5], type=float, nargs="+")
